...
(display "Alyssa P. Hacker complains that we went to a lot of extra work in writing expmod.
...
(display "Define a procedure next that re- turns 3 if its input is equal to 2 and otherwise returns its in- put plus 2.
